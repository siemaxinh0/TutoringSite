    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.ManyToManyField(blank=True, related_name='users', to='tutoring.role')),
                ('subjects', models.ManyToManyField(blank=True, related_name='teachers', to='tutoring.subject')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lessons', to='tutoring.subject')),
            ],
        ),
    ]
